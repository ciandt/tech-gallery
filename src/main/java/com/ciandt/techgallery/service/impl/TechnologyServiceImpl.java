...
public class TechnologyServiceImpl implements TechnologyService {
    ...
    private void verifyFilters(TechnologyFilter techFilter, List<Technology> completeList,
        ...
        for (Technology technology : completeList) {
            if (verifyTitleAndShortDescriptionFilter(techFilter, technology)) {
                if (techFilter.getRecommendationIs() != null) {
                    if (verifyRecommendationFilter(techFilter, technology, project)) {
            ...
            } else if (verifyRecommendationFilter(techFilter, technology, project) && techFilter.getTitleContains() == null) {
                filteredList.add(technology);
                continue;
            }
        }
    ...
    private boolean verifyRecommendationFilter(TechnologyFilter techFilter, Technology technology, Project project) {
